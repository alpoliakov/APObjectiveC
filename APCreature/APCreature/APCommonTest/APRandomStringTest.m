...
+ (void)performRandomStringTests {
    ...
    NSLog(@"\n%@", [NSString randomStringWithLength:12 alphabet:[NSString randomString]]);
    ...
    NSLog(@"\n%@", [NSString randomStringWithLength:10 alphabet:
                    [NSString capitalizedLetterAlphabet]]);
    NSLog(@"\n%@", [NSString randomStringWithLength:8 alphabet:[NSString alphanumericAlphabet]]);
    NSLog(@"\n%@", [NSString alphabetWithUnicodeRange:NSMakeRange(0, 5)]);
    NSLog(APOutputDelimiter);
}
